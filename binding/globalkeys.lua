...
function _M.get()
  local globalkeys = gears.table.join(awful.key({modkey}, "/",
      ...
      awful.key({modkey}, "Return", function()
        awful.spawn("launchWithNvidia " .. terminal)
      ...
      end), awful.key({modkey, "Control"}, "Up", function()
        awful.client.moveresize(0, 0, 0, 50)
      end), awful.key({modkey, "Control"}, "Left", function()
